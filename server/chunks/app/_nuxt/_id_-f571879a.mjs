...
import { ref, withAsyncContext, mergeProps, unref, isRef, withCtx, createTextVNode, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(async () => ([__temp, __restore] = withAsyncContext(() => fetch(`${runtimeConfig.public.apiBase}/centres`)), __temp = await __temp, __restore(), __temp).json()), __temp = await __temp, __restore();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "my-20 mx-10" }, _attrs))}><div><h2 class="sr-only">Steps</h2><div><p class="text-md font-medium text-gray-500">${ssrInterpolate(unref(activeStep))}/5 - PROGRESS</p><div class="mt-4 overflow-hidden rounded-full bg-gray-200"><div style="${ssrRenderStyle(unref(activeStep) == 1 ? null : { display: "none" })}" class="h-2 w-1/6 rounded-full bg-blue-500"></div><div style="${ssrRenderStyle(unref(activeStep) == 2 ? null : { display: "none" })}" class="h-2 w-2/6 rounded-full bg-blue-500"></div><div style="${ssrRenderStyle(unref(activeStep) == 3 ? null : { display: "none" })}" class="h-2 w-3/6 rounded-full bg-blue-500"></div><div style="${ssrRenderStyle(unref(activeStep) == 4 ? null : { display: "none" })}" class="h-2 w-4/6 rounded-full bg-blue-500"></div><div style="${ssrRenderStyle(unref(activeStep) == 5 ? null : { display: "none" })}" class="h-2 w-full rounded-full bg-blue-500"></div></div></div></div><form><div id="steps" class="text-center"><div class="flex w-full mt-20 justify-center"><div class="w-full sm:w-1/2 text-left"><div class="" style="${ssrRenderStyle(unref(activeStep) == 1 ? null : { display: "none" })}"><div class="text-3xl font-bold">Course</div><div class="field"><div class="dummy mb-3"><label for="" class="label">Test</label><input type="text" class="input"${ssrRenderAttr("value", unref(courseid))} name="courseid"><input type="text" class="input"${ssrRenderAttr("value", unref(centreid))} name="centreid"><div class="field"><label class="label"> Test : Date Selected ! </label><div class="control"><input type="text" class="input"${ssrRenderAttr("value", unref(date))} name="date" placeholder="date"></div></div></div></div><div class="mt-6"><label for="" class="text-xs sm:text-lg font-medium text-gray-600"> Course </label><select id="" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" name="coursename" required><option${ssrRenderAttr("value", unref(coursename))}>${ssrInterpolate(unref(coursename))}</option></select></div></div><div class="" style="${ssrRenderStyle(unref(activeStep) == 2 ? null : { display: "none" })}"><div class="font-bold text-3xl"> Personal </div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/register/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-f571879a.mjs.map
